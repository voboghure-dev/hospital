            ...
            <table cellspacing="0" border="0" style="border-collapse: collapse;" id="gvItemList" class="GridView">
              <tbody>
                <tr align="left" style="font-family: Arial; text-decoration: none;">
                  ...
                  <th align="left" style="width: 80px;" scope="col">Receive ID</th>
                  <th align="left" style="width: 100px;" scope="col">Item Name</th>
                  <th align="left" style="width: 80px;" scope="col">Quantity</th>
                  <th align="left" style="width: 150px;" scope="col">Supplier</th>
                  <th align="left" style="width: 75px;" scope="col">Entry Date</th>
                </tr>
                <tr>
                  <td colspan="6"><a href="receive/add?height=250&width=400&modal=true" class="thickbox" title="Receive Entry"><img src="images/btn_add.gif" border="0" /></a></td>
                </tr>
                <?php
                  $i = 1;
