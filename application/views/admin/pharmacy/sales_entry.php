  ...
  <div id="content">
    ...
    <div id="itemlisting">
      <div id="customerheader">
        <form name="sales" method="post" action="pharmacy/add">
    ...
    <div id="mainsalenav">
      <ul>
        <li><a href="pharmacy/find_item/<?php echo $this->uri->segment(3); ?>?height=400&width=400&modal=true" class="thickbox" title="Find Item"><img src="images/btn_add_item.png" border="0" height="105" width="113"></a></li>
        <li><a href="pharmacy/set_customer/<?php echo $this->uri->segment(3); ?>?height=400&width=400&modal=true" class="thickbox" title="Set Customer"><img src="images/btn_set_customer.png" border="0" height="105" width="113"></a></li>
        <!--
    ...
    <div id="secondarysalenav">
      <ul>
        ...
        <li><a href="pharmacy/new_item/?height=250&width=400&modal=true" class="thickbox" title="New Item">New Item</a></li>
