<div id="center-column">
  ...
  <div class="table">
    ...
    <?php echo form_open('accounts/add_journal_voucher_details', 'name="journal_voucher" id="journal_voucher"'); ?>
    ...
    <?php
      ...
      echo form_open('accounts/journal_voucher_list', 'name="voucher_list" id="voucher_list"');
    ?>
