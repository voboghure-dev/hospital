<div id="center-column">
  ...
  <div class="table">
    ...
    <?php echo form_open('accounts/add_credit_voucher_details', 'name="credit_voucher" id="credit_voucher"'); ?>
    ...
    <?php
      ...
      echo form_open('accounts/credit_voucher_list', 'name="voucher_list" id="voucher_list"');
    ?>
    <table class="listing form" cellpadding="0" cellspacing="0" style="margin-top: 10px;">
      ...
      <tr>
        ...
        <td><?php echo number_format($value['credit'], 2); ?></td>
...
<script type="text/javascript">
  document.credit_voucher.cr_chart_id.focus();
