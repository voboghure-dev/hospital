<div id="center-column">
  ...
  <div class="table">
    ...
    <table class="listing form" cellpadding="0" cellspacing="0">
      <tr>
        <th class="full" colspan="4">Debit Voucher Update</th>
      </tr>
      <tr>
      ...
      <tr class="bg">
        ...
        <td valign="top" style="padding-left: 5px; text-align: left;">
          <select name="emp_id" class="required" style="width: 236px;">
            ...
            <option value="<?php echo $value['id']; ?>" <?php if($value['id']==$debit_voucher['emp_id']){ ?>selected<?php } ?>><?php echo $value['name']; ?></option>
            <?php } ?>
          </select>
        </td>
